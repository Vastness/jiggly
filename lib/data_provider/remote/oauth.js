...
function getLoginUser() {
  ...
  return request.getAsync({
     ...
     */
    _.assign(user, {
      id: java.Long(user.id || null),
      mainId: java.Long(user.mainId || null),
      orgId: java.Long(user.orgId || null),
      depId: java.Long(user.depId || null),
      posts: java.array.String(user.posts),
      entrustId: java.Long(user.entrustId || null),
      shopId: java.Long(user.shopId || null)
    })
